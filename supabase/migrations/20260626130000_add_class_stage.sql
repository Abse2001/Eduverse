...
drop function if exists public.create_class(uuid, text, text, text, text, text, text, text);
drop function if exists public.update_class(uuid, text, text, text, text, text, text, text);
...
create function public.update_class(
